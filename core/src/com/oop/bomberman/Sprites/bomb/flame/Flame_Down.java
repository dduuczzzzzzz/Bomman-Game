...
public class Flame_Down extends Flame{
    public Flame_Down(PlayScreen screen, float x, float y, Bomb bomb) {
        super(screen, x, y,bomb);
        fire = new TextureRegion(screen.getBomb_atlas().findRegion("explode_down"), 0, 0, 16, 32);
        setRegion(fire);
    }
