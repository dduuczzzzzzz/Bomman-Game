...
public class Flame_Mid extends Flame {
    public Flame_Mid(PlayScreen screen, float x, float y, Bomb bomb) {
        super(screen, x, y,bomb);
        fire = new TextureRegion(screen.getBomb_atlas().findRegion("flame_mid"), 0, 0, 16, 16);
        setRegion(fire);
    }
    ...
    public void defineFlame(Bomb bomb) {
        ...
        bdef.position.set(bomb.b2body.getPosition().x, bomb.b2body.getPosition().y);
