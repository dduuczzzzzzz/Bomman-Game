...
public class Flame_Right extends Flame {
    public Flame_Right(PlayScreen screen, float x, float y, Bomb bomb) {
        super(screen, x, y,bomb);
        fire = new TextureRegion(screen.getBomb_atlas().findRegion("explode_right"), 0, 0, 32, 16);
        setRegion(fire);
    }
