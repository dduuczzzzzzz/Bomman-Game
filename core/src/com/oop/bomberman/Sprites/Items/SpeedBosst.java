...
public class SpeedBosst extends Item{

    public SpeedBosst(PlayScreen screen, float x, float y) {
        super(screen, x, y);
        setRegion(screen.getAtlas().findRegion("powerup_speed"), 0, 0, 16, 16);
    ...
    public void defineItem() {
        ...
        fdef.filter.categoryBits = Bomberman.ITEM_BIT;
