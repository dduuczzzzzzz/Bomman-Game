...
public class Portal extends Item{
    public Portal(PlayScreen screen, float x, float y) {
        super(screen, x, y);
        setRegion(screen.getAtlas().findRegion("portal"), 0, 0, 16, 16);
    ...
    public void defineItem() {
        ...
        fdef.filter.categoryBits = Bomberman.ITEM3_BIT;
    ...
    @Override
    public void useItem() {
        Bomberman.manager.get("audio/sounds/CRYST_UP.wav", Sound.class).play();
        setDestroy();
    }
